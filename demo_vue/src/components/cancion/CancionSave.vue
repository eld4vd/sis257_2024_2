...
//aqui en el onMounted se ejecutan las funciones que se necesitan para cargar los datos
onMounted(() => {
  obtenerGeneros()
  obtenerInterpretes()
  obtenerAlbumes()
...
<template><!-- aquie en el template se muestra la vista de la pagina , se esta maquetando con el primevue-->
  <div class="card flex justify-center">
    ...
    >
      <div class="flex items-center gap-4 mb-4">
        <label for="genero" class="font-semibold w-4">Generos</label>
        <Select
          id="genero"
      ...
      <div class="flex items-center gap-4 mb-4">
        <label for="duracion" class="font-semibold w-4">Duracion</label>
        <InputText
          id="duracion"
